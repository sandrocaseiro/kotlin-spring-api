...
import com.sandrocaseiro.template.models.domain.EGroup
...
import com.sandrocaseiro.template.utils.anyNonNull
...
class UserServiceTest {
    ...
    fun testCannotCreateUserWithSameEmail() {
        ...
        assertThatExceptionOfType(UsernameAlreadyExistsException::class.java).isThrownBy { userService.create(user) }
    }
    ...
    fun testCannotUpdateNotExistingUser() {
        ...
        assertThatExceptionOfType(ItemNotFoundException::class.java).isThrownBy { userService.update(user) }
    }
    ...
    fun testUpdateBalanceWithNotExistingUserShouldThrowException() {
        ...
        assertThatExceptionOfType(ItemNotFoundException::class.java).isThrownBy { userService.updateBalance(999, balance) }
    }

    @Test
    fun testUserCannotDeleteHimself() {
        assertThatExceptionOfType(ForbiddenException::class.java).isThrownBy { userService.delete(1) }
    }

    @Test
    fun testUserCannotDeleteNotExistingUser() {
        assertThatExceptionOfType(ItemNotFoundException::class.java).isThrownBy { userService.delete(999) }
    }
    ...
    fun testFindNotExistingUserShouldThrowException() {
        assertThatExceptionOfType(ItemNotFoundException::class.java).isThrownBy { userService.findById(999) }
    }
